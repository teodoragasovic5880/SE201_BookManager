...
public class InsertBookPageController
{
    ...
    @FXML
    private DatePicker authorDobPicker;
    @FXML
    ...
    @FXML
    private Text titleErrorLabel;
    @FXML
    private Text authorNameErrorLabel;
    @FXML
    private Text authorSurnameErrorLabel;
    @FXML
    private Text authorDobErrorLabel;
    @FXML
    private Text categoryErrorLabel;
    @FXML
    private Text imagePathErrorLabel;
    @FXML
    private Text statusErrorLabel;
    ...
    private void handleSubmitUnsafe()
    {
        ...
        try
        {
            ...
            System.out.println("Unsafe demo: statement executed.");
